(() => {
  ...
  const transTT = (t) => {
    const result = new Int32Array(t.length);
  ...
  const genTT1 = () => {
    const TT1 = transTT(T1);
    let line = "";
    for (let i = 0; i < 16; i++) {
      for (let j = 0; j < 16; j++) {
        const index = i * 16 + j;
        line += toHex(TT1[index], 32, true) + ", ";
      }
      line += "\n";
    }
    console.log(line);
  ...
  const genTT2 = () => {
    const TT2 = transTT(T2);
    let line = "";
    for (let i = 0; i < 16; i++) {
      for (let j = 0; j < 16; j++) {
        const index = i * 16 + j;
        line += toHex(TT2[index], 32, true) + ", ";
      }
      line += "\n";
    }
    console.log(line);
  ...
  const genTT3 = () => {
    const TT3 = transTT(T3);
    let line = "";
    for (let i = 0; i < 16; i++) {
      for (let j = 0; j < 16; j++) {
        const index = i * 16 + j;
        line += toHex(TT3[index], 32, true) + ", ";
      }
      line += "\n";
    }
    console.log(line);
  ...
  const genTT4 = () => {
    const TT4 = transTT(T4);
    let line = "";
    for (let i = 0; i < 16; i++) {
      for (let j = 0; j < 16; j++) {
        const index = i * 16 + j;
        line += toHex(TT4[index], 32, true) + ", ";
      }
      line += "\n";
    }
    console.log(line);
